...
namespace Presentation.Areas.Systems.Controllers {
    ...
    /// 应用程序控制器
    /// </summary>
    public class Application3Controller : FormControllerBase<ApplicationDto, ApplicationQuery> {
        /// <summary>
        /// 初始化应用程序控制器
        /// </summary>
        /// <param name="applicationService">应用程序服务</param>
        public Application3Controller( IApplicationService applicationService )
